...
public class Tool {
  ...
  public static final String SMS_OAUTH_TOKEN_URL = "https://sms.gabia.com/oauth/token"; // ACCESSTOKEN 발급API URL 입니다.

  public static String getSMSToken() throws IOException {
    String smsId = "k1mseonghosms"; // SMS ID 를 입력해 주세요.
    String apiKey = "7d778e4de3761e2ff969ab325ac076f3"; // SMS 관리툴에서 발급받은 API KEY 를 입력해 주세요.
